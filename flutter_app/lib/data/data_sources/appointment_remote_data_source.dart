...
class AppointmentRemoteDataSource {
  ...
  Future<List<AppointmentDto>> list({String? barberId, String? date}) async {
    ...
    return (await _api.get('/appointments', query: query) as List)
        .map((item) => AppointmentDto.fromJson(item as Map<String, dynamic>))
        .toList();
  }

  Future<AppointmentDto> create(Map<String, dynamic> input) async =>
      AppointmentDto.fromJson(
          await _api.post('/appointments', input) as Map<String, dynamic>);
